...
<a href='/route/modals/users/edit.php?action=edit&tenant=<?php print urlencode($_params['tenant']); ?>&id=<?php print (int)$view_user->id; ?>' class='btn btn-sm bg-info-lt' data-bs-toggle='modal' data-bs-target='#modal1'>
...
<a href='/route/modals/users/edit.php?action=delete&tenant=<?php print urlencode($_params['tenant']); ?>&id=<?php print (int)$view_user->id; ?>' class='btn btn-sm bg-info-lt text-danger' data-bs-toggle='modal' data-bs-target='#modal1'>
